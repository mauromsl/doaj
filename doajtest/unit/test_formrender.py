    ...
    def test_04_application_renderer(self):
        ...
        for g in r.NUMBERING_ORDER:
            ...
            for obj in cfg:
                ...
                q += 1
        assert q == 60, q # checks that we checked everything (59 questions, plus an extra 1 from the end of the loop)
        ...
        for g in r.ERROR_CHECK_ORDER:
            ...
            for obj in cfg:
                ...
                q += 1
        assert q == 60 # makes sure we've checked all the fields (59 questions, plus an extra 1 from the end of the loop)
